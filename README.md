About interlap-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/interlap-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/brentp/interlap

Documentation: https://brentp.github.io/interlap
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5612&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/interlap-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `interlap` can be installed with `conda`:
...
```
mamba install interlap
```

It is possible to list all of the versions of `interlap` available on your platform with `conda`:
...
```
mamba search interlap --channel conda-forge
```
...
mamba repoquery search interlap --channel conda-forge

# List packages depending on `interlap`:
mamba repoquery whoneeds interlap --channel conda-forge

# List dependencies of `interlap`:
mamba repoquery depends interlap --channel conda-forge
```
